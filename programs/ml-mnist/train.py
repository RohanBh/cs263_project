"""This module trains a 2-layer neural network with 128 neurons in the first layer and 10 neurons in the second (output layer).
We train the neural network with SGD. The first layer of the network uses the tanh activation function while the second layer 
uses the sigmoid activation function. It takes about 30s to complete one epoch. The network reaches more than 
